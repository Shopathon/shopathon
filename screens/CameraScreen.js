	...
	takePicture = function() {
		...
		if (this.camera) {
			this.camera.takePictureAsync().then(data => {
				...
				const ClOUDINARY_URL = "https://api.cloudinary.com/v1_1/dizi91pkj/upload";
				const CLOUDINARY_PRESET_URL = "nwgfnkmt";
				const img = data.uri;
				...
				fetch(ClOUDINARY_URL, {
					...
					res.json().then(function(data) {
						...
						axios.post("https://shielded-mesa-86644.herokuapp.com/new/coupon/" + comp.props.navigation.state.params.id, {
	...
	renderLandmarksOfFace(face) {
		...
		position && (
			<View
				style={[
					styles.landmark,
					{ left: position.x - landmarkSize / 2, top: position.y - landmarkSize / 2, },
				]}
			/>
		);
		return (
