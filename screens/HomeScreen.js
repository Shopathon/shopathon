   ...
   componentDidUpdate(){
    ...
    renderStores () {
        return (this.state.stores?this.state.stores.map((stores, index) =>
            <StoreButton navigate={this.props.navigation.navigate} key={index} id={stores._id} name={stores.store}/>) : null )};
								...
								<ScrollView style={styles.container}>
                                    <View style={styles.modalContainer}>
										...
										<View style={styles.devLinks}>
											<Text onPress={this._handleGithubJoe} style={styles.linkText}>Github</Text>
											<Text style={styles.devName}>Joseph Musser</Text>
											<Text onPress={this._handleLinkedJoe} style={styles.linkText}>Linked-In</Text>
										</View>
										<View style={styles.devLinks}>
											<Text onPress={this._handleGithubAusten} style={styles.linkText}> Github</Text>
											<Text style={styles.devName}>Austen Pritchett</Text>
											<Text onPress={this._handleLinkedAusten} style={styles.linkText}> Linked-In</Text>
										</View>
										<View style={styles.devLinks}>
											<Text onPress={this._handleGithubJordan} style={styles.linkText}> Github</Text>
											<Text style={styles.devName}>Jordan Higgins</Text>
											<Text onPress={this._handleLinkedJordan} style={styles.linkText}> Linked-In</Text>
										</View>
										<View style={styles.devLinks}>
											<Text onPress={this._handleGithubZiwei} style={styles.linkText}> Github</Text>
											<Text style={styles.devName}>Ziwei Zhang</Text>
											<Text onPress={this._handleLinkedZiwei} style={styles.linkText}> Linked-In</Text>
										</View>
										<View style={styles.devLinks}>
											<Text onPress={this._handleGithubChase} style={styles.linkText}> Github</Text>
											<Text style={styles.devName}>Chase Millet</Text>
											<Text onPress={this._handleLinkedChase} style={styles.linkText}> Linked-In</Text>
										</View>
                                    </View>
								</ScrollView>
