...
export default class LinksScreen extends React.Component {
	...
	couponCall(id) {
		axios.get('https://shielded-mesa-86644.herokuapp.com/all/coupons/' + id)
			.then((response) => { this.setState({ modalVisible: true, coupons: response.data }); })
	...
	deleteList = (id, navigate) => {
		let self = this
		  ...
		  axios.delete('https://shielded-mesa-86644.herokuapp.com/delete/list/' + id, { })
			.then(function (response) { navigate('Home'); })
			.catch(function (error) { console.log(error); });
	};
	renderCoupons() {
						...
						<View style={styles.buttonContainer}>
							<View>
								<Button
									...
									title={ <Text style={styles.listBoxAddText}> Checkout </Text> } />
							</View>
							<View>
								<Button
									...
									title={ <Text style={styles.listBoxAddText}> Delete List </Text>} />
							</View>
						</View>
					</ShopList>	
				</View>
							...
							<View style={styles.listContainer}>
								...
								<View style={{marginTop: 20, marginBottom: 20}}>
									<Button
										...
										title={ <Text style={styles.listBoxAddText}> Close </Text> } />
								</View>
							</View>
						</ScrollView>
					</ImageBackground>
